...
//                           MainFamilyRepo mainFamilyRepo, List<DirectiveGuards> contactDirective, MemberRepository memberRepository) {
...
//            System.out.println(mainMember.getUuid());
...
//            ShortFamilyMember member = memberRepository.findMemberWithPrimeFamily(processDirective.getFamilyMemberDto().getUuid()).orElseThrow(() -> new RuntimeException("person not found"));
//            if (member == null) {
...
//                memberService.updateMember(anyBrother);
//                storageDirective.add(FamilyDirective.builder()
...
//        }
//        ShortFamilyMember shortFamilyMember = memberService.getPersonForLinking(familyMemberDto.getUuid());
...
//        Optional<ShortFamilyMember> mainMember = memberService.getMemberByUuid(uuid);
...
//        ShortFamilyMember mainMember = memberRepository.findMemberWithPrimeFamily(uuid).orElseThrow(() -> new RuntimeException("person not found"));
...
//        Family primeFamily = mainMember.getFamilyWhereChild();
//        UUID tokenUuid = guardFromToken.getLinkedPerson().getUuid();
//        System.out.println(mainMember.getCheckStatus());
//        System.out.println(primeFamily.getGuard());
//        System.out.println(primeFamily.getGlobalFamily().getGuard());
//        if (mainMember.getCheckStatus() == CheckStatus.UNCHECKED) return SecretLevel.CONFIDENTIAL;
//        if (mainMember.getCheckStatus() == CheckStatus.LINKED && (tokenUuid == mainMember.getUuid()))
//            return SecretLevel.CONFIDENTIAL;
//        if (mainMember.getCheckStatus() == CheckStatus.LINKED && primeFamily.getGuard().contains(guardFromToken))
//            return SecretLevel.FAMILY;
//        if (mainMember.getCheckStatus() == CheckStatus.LINKED && primeFamily.getGlobalFamily().getGuard().contains(guardFromToken))
//            return SecretLevel.GLOBAL_TREE;
//        if (mainMember.getCheckStatus() == CheckStatus.CHECKED && primeFamily.getGuard() != null && !primeFamily.getGuard().isEmpty() && primeFamily.getGuard().contains(guardFromToken))
//            return SecretLevel.CONFIDENTIAL;
//        if (mainMember.getCheckStatus() == CheckStatus.CHECKED && (primeFamily.getGuard() == null || primeFamily.getGuard().isEmpty()) && primeFamily.getGlobalFamily().getGuard().contains(guardFromToken))
//            return SecretLevel.CONFIDENTIAL;
