...
import ru.memman.feign.NotificationConnectionClient;
...
public class ContactService {
    ...
    public ContactService(Map<String, Set<String>> rightsMap, FileStorageService fileStorageService, TokenService tokenService, NotificationConnectionClient notificationConnectionClient) {
