...
public class FrontBackgroundHolder {
    ...
    @Value("${application.picture.start}")
    private String star;
    ...
    void setUP() throws IOException {
        InputStream in = getClass()
                .getResourceAsStream(star);
        if (in != null) this.setStart(IOUtils.toByteArray(in));
        else log.warn("Main picture of about page not loading");
    }
    ...
    void setMainPicture() throws IOException {
        ...
        else log.warn("Main picture of main page not loading");
    }
}
