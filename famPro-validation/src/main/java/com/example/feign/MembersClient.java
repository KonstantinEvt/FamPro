...
@FeignClient(name = "FAMPRO-STORAGE", configuration = FeignRequestIntercepter.class, fallbackFactory = MembersClient.FamilyMemberFallbackFactory.class)
...
@Slf4j
record FallFamilyMember(String reason) implements MembersClient {
